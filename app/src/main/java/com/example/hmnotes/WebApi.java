...
//                requestQueue.add(new StringRequest(method, url, getResponseListener(listener, url),
//                        getErrorListener(errorListener, url)) {
//                    {
...
//    }
//
//    public static Response.Listener<String> getResponseListener(final Response.Listener<JsonObject> listener,
//                                                         final String url) {
...
//
//
//    public OnSuccessListener<TResult> getOnSuccessListener(final Response.Listener<JsonObject> listener,
//                                                         final Response.ErrorListener errorListener,
//                                                         final String url) {
//
//        return new OnSuccessListener<TResult>() {
//            requestQueue.add(new StringRequest(method, url, getResponseListener(listener, url),
//            getErrorListener(errorListener, url)));
//            @Override
//            public byte[] getBody() throws AuthFailureError {
